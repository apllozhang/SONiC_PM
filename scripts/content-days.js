...
const day01 = {
  file: 'day-01.html',
  title: '第 1 天 · 产品地图',
  description: '分清芯片、整机、镜像、服务四层责任；建立 SONiC 产品参照框架与核验包草稿。',
  kicker: '入门 / 第 1 天',
  h1: '产品地图：先分清谁负责什么',
  lead: '第 1 天不背命令。先立参照框架：芯片能力、平台适配、镜像来源、硬件型号、测试加固、售后支持，每一层都要能对应到具体版本和负责人。',
...
<p>同一句话在不同材料里指的往往不是同一层。芯片厂页面写「Enterprise SONiC 支持基于 StrataXGS 的 50 多个 ODM/OEM 平台」，说的是生态范围，不是某一块板卡的硬件兼容列表（HCL）。整机厂页面写「已在 1G–400G 开放交换机上 加固」，说的是方法路径，不等于你的目标型号已进正式支持清单。</p>
...
<div class="callout"><strong>硬性原则：</strong>不能把同 ASIC 的不同板卡设计笼统当成同一种支持状态；不能把芯片级公开定位推成客户部署已获支持。</div>
