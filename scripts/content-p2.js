...
<h2>L1–L3 能力梯度</h2>
<p>五个维度上，三级目标的能力厚度不同。雷达用于对照「我现在在哪、下一级差哪块」，不作精密打分。</p>
<div class="chart-wrap" role="img" aria-label="L1 到 L3 能力雷达图，对比责任分层、功能验收、架构理解、测试证据、定型商业化五个维度">
  <div id="level-radar" class="path-chart path-chart--radar"></div>
</div>
<p class="muted" style="font-size:12px;margin-top:4px">读法：L1 重在问对问题；L2 补架构与测试证据；L3 在定型与商业化上拉满。</p>
