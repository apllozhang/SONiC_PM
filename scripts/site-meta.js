...
const CHANGELOG = [
  {
    ...
    summary: '培训可用性与知识底座改版（评审 P0+P1+P2）',
    changes: [
      '统一全站版本号 v2.0.0，新增本页与内容负责人列',
      '每页增加 3–5 道自测题（可折叠答案）与动手任务验收标准',
      '首页增加 PM / 售前 / 测试角色导航与培训使用说明（周期、考核、结业）',
      '架构线扩容：容器全景、Redis 库表速查、容器重启影响矩阵',
      '新增功能特性地图、版本与生态坐标系（含官方外链）',
      '每条能力线至少 1 个真实样例（配置片段 / 命令 / 报告节选）',
      '定义 L1–L3 能力等级并映射 12 周路线；新增 FAQ 与全站目录',
      '保留：四层责任地图、参数四态、核验包 10 字段、案例六层追问',
    ],
  },
  {
    version: '1.1.0',
